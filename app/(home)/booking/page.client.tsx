...
export function PageClient() {
  ...
  const kembalian =
    form.metode_pembayaran === "cash" ? uangBayarNum - estimasiHarga : 0;
  const cashKurang =
    form.metode_pembayaran === "cash" &&
    estimasiHarga > 0 &&
    uangBayarNum < estimasiHarga;
  ...
  if (success) {
    return <Receipt success={success} form={form} />;
  }
              ...
              {form.metode_pembayaran === "cash" && (
                <div className="liras-booking__field">
                  ...
                  {estimasiHarga > 0 && uangBayarNum > 0 && (
                    <p
                      className={`liras-booking__cash-info${cashKurang ? " liras-booking__cash-info--kurang" : ""}`}
                    >
                      {cashKurang
